...
public class GetAllBooksTest {
    ...
    public void getAllBooksWithNewBookTest() {
        ResponseAuthorSave author = Specification.reqSpecSaveAuthor(RandomStringUtils.randomAlphabetic(3), RandomStringUtils.randomAlphabetic(3), RandomStringUtils.randomAlphabetic(3), 1900, 2, 11, 201);
